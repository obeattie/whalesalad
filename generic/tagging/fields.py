...
class TagField(CharField):
    ...
    """
    def __init__(self, model=Tag, *args, **kwargs):
        self.model = model
    ...
    def __get__(self, instance, owner=None):
        ...
        if instance is None:
            return edit_string_for_tags(self.model.objects.usage_for_model(owner))
        ...
        if tags is None:
            if instance.pk is None:
                ...
                self._set_instance_tag_cache(
                    instance, edit_string_for_tags(self.model.objects.get_for_object(instance)))
    ...
    def _save(self, signal, sender, instance, **kwargs):
        ...
        tags = self._get_instance_tag_cache(instance)
        if tags is not None:
            self.model.objects.update_tags(instance, tags)
    ...
    def formfield(self, **kwargs):
        from whalesalad.generic.tagging import forms
